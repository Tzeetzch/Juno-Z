...
public class UserService : IUserService
{
    ...
    public UserService(IAppDbContext db, ILogger<UserService> logger, IPasswordService passwordService)
    {
        _db = db;
        _logger = logger;
    ...
    public async Task ResetParentPasswordAsync(int targetUserId, string newPassword, int callerAdminId)
    {
        ...
        target.PasswordHash = _passwordService.HashPassword(newPassword);
